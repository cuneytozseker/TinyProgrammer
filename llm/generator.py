...
class LLMGenerator:
    ...
    def build_prompt(self, program_type: str, mood: str, lessons: str = "") -> str:
        ...
        prompt = (
            f"{lessons_text}"
            f"Write a VERY SHORT Python program that {description}.\n\n"
            "STRICT RULES:\n"
            "- MAXIMUM 20 lines of code\n"
            "- NO imports (already done)\n"
            "- NO functions, NO classes\n"
            "- Start with 2-3 variables, then while True loop\n"
            "- Screen: 480x320\n\n"
            "Available: c.clear(r,g,b), c.fill_rect(x,y,w,h,r,g,b), c.fill_circle(x,y,r,r,g,b), c.sleep(sec)\n\n"
            "Output ONLY code, no explanation. Example format:\n"
            "x = 100\n"
            "y = 100\n"
            "while True:\n"
            "    c.clear(0,0,0)\n"
